          ...
          <section>
            ...
            <ul className="space-y-3 list-none">
              {[
                ...
                ["Website", "refers to Vision Breath Solutions, accessible from https://visionbreathsolutions.com/"],
          ...
          <section className="bg-brand-50 rounded-2xl p-6 border border-brand-100">
            ...
            <ul className="space-y-2 text-sm">
              <li>🌐 <strong>Website:</strong>{' '}
                <a href="https://visionbreathsolutions.com/contact" target="_blank" rel="noopener noreferrer" className="text-brand-600 hover:underline">
                  https://visionbreathsolutions.com/contact
                </a>
              </li>
            </ul>
          </section>
